...
function rainbow_edu_scripts() {
    wp_enqueue_style( 'rainbow-edu-fonts', 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap', array(), null );
...
function rainbow_edu_nav_link_attrs( $atts, $item, $args ) {
    if ( $args->theme_location === 'primary' ) {
        $atts['class'] = 'text-gray-700 font-medium hover:text-indigo-600 transition-colors focus:outline-none focus:underline';
    }
    return $atts;
}
